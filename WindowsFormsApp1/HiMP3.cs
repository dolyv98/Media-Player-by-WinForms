...
{
	public partial class HiMP3 : Form
	{
		...
		private void Playing_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			using (SqlConnection con = new SqlConnection(connectionString))
			{
				...
				cmd.Parameters.Add("@ThamSo1", SqlDbType.NVarChar, 100).Value = MediaPlayer.URL;
		...
		// Opening the listening History
		private void recentbtn_Click(object sender, EventArgs e)
		{
            ListeningHistory frmMusic = new ListeningHistory();
            frmMusic.Show();
